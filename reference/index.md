...
- [`isPathAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/reference/isPathAbsolute.md)
  [`validateIsPathAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/reference/isPathAbsolute.md)
  [`validatePathIsAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/reference/isPathAbsolute.md)
