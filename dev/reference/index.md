...
- [`isFileExtension()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isFileExtension.md)
...
- [`isIncluded()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isIncluded.md)
  [`validateIsIncluded()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isIncluded.md)
  : Check if a vector of values is included in another vector of values

- [`isOfLength()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isOfLength.md)
  [`validateIsOfLength()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isOfLength.md)
  : Check if the provided object has expected length

- [`isOfType()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isOfType.md)
...
- [`isPathAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isPathAbsolute.md)
  [`validateIsPathAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isPathAbsolute.md)
  [`validatePathIsAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isPathAbsolute.md)
  : Check if path is absolute

- [`isSameLength()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isSameLength.md)
  [`validateIsSameLength()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isSameLength.md)
  : Validate if objects are of same length

- [`isUTF8()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/isUTF8.md)
...
- [`validateIsOfType()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/validateIsOfType.md)
  ...
  [`validateIsNumeric()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/validateIsOfType.md)
  [`validateIsInteger()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/validateIsOfType.md)
  [`validateIsLogical()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/validateIsOfType.md)
...
- [`ifNotNull()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/ifNotNull.md)
  :
...
- [`ospsuiteUtilsSettingNames`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/ospsuiteUtilsSettingNames.md)
  :
...
- [`Printable`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/Printable.md)
  : Printable
...
- [`getLogFolder()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/getLogFolder.md)
  : getLogFolder
...
- [`toList()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/toList.md)
...
- [`toc()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/toc.md)
  : toc

- [`messages`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/messages.md)
  : List of functions and strings used to signal error messages

- [`objectCount()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/objectCount.md)
...
- [`tic()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/tic.md)
  : tic

- [`timeStamp()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/timeStamp.md)
  : timeStamp
