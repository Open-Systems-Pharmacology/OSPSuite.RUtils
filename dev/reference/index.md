...
- [`validatePathIsAbsolute()`](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/validatePathIsAbsolute.md)
...
- [`` `%||%` ``](https://www.open-systems-pharmacology.org/OSPSuite.RUtils/dev/reference/op-null-default.md)
  :
